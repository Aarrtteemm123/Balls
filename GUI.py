...
class Interface(object):
    def __init__(self):
        ...
        self.txtSimulation = self.font.render('                               Simulation', True, self.DEFAULT_TEXT_COLOR)
        ...
        self.txtNumThreads = self.font.render('Threads: ' + str(Config.App.NUMBER_THREADS), True, self.DEFAULT_TEXT_COLOR)
        ...
        self.txtOrientation = self.font.render('                              Orientation', True, self.DEFAULT_TEXT_COLOR)
